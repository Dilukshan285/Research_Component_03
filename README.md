...
| **Backbone R(2+1)D-18 → R3D-18** | MAE 4.1417, bal-acc 0.6533 | MAE 4.1175, bal-acc 0.6790 | −0.024 / +0.026 — **not significant**, p = 0.889 | ✅ **Fully** — matched seed, epochs, data, heads, loss; identical decision rule (`outputs/uefnet_r3d/`, `run_backbone_ablation.py`) |
